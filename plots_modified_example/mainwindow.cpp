...
void MainWindow::setupDemo(int demoIndex)
{
  switch (demoIndex)
  {
    case -1: setupMyDemo(ui->customPlot); break;
...
void MainWindow::setupMyDemo(QCustomPlot *customPlot)
{
  ...
  QFile file(filename);
#endif
  QFile file("/home/savum/WORK/Uni/patient001/samples.csv");
  ...
  file.close();
  QFile file1("/home/savum/WORK/Uni/patient001/samples.csv");
...
//    y3.append(line.split(',').at(13).toDouble() - 7.5);
    y3.append(line.split(',').at(2).toDouble() - 7.5);
  }
  file1.close();
  QFile file2("/home/savum/WORK/Uni/patient001/samples.csv");
...
//    y3.append(line.split(',').at(14).toDouble() - 7.5);
    y3.append(line.split(',').at(2).toDouble() - 7.5);
  }
  file2.close();
  QFile file3("/home/savum/WORK/Uni/patient001/samples.csv");
  ...
  while (!file3.atEnd()) {
    ...
    //    y3.append(line.split(',').at(15).toDouble() - 7.5);
    y3.append(line.split(',').at(2).toDouble() - 7.5);
...
//  demoName = "My Demo";
//  // generate some data:
//  QVector<double> x(101), x1(101), x2(101), x3(101), y(101), y1(101), y2(101),y3(101); // initialize with entries 0..100
//#if 0
//  QString fileName = QFileDialog::getOpenFileName(this, tr("Open File"),
//                                                  "/home/savum/WORK/Uni",
//                                                  tr("Samples (*.csv)"));
...
//    x3.append(xVal + 30);
//    xVal += 0.001;
////    y.append(wordList.at(1).toDouble());
////    qDebug() << line.split(',');
//    y.append(line.split(',').at(1).toDouble());
//    y1.append(line.split(',').at(4).toDouble());
//    y2.append(line.split(',').at(7).toDouble());
//    y3.append(line.split(',').at(10).toDouble());
////    wordList.clear();
//  }
////  qDebug() << y1.at(100);
////  y.append(y1);
...
////      y.append(y2.at(i).toDouble());
////  for(int i = 0; i < y.size(); i++)
////      y.append(y3.at(i).toDouble());
